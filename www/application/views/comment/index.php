            ...
            <div class="mycenter">
                ...
                <div class="myCont floatright">
                    ...
                    <div class="all-order hidden">
                        ...
                        <div class="noOrder">
                            <img src="<?php echo IMG?>/common/noOrder.png">
                            ...
                            <table>
                                ...
                                <tr class="body-head">
                                    <td colspan="7" class="text-left">
                                        ...
                                        <span class="deleteBtn"><img src="<?php echo IMG?>/common/deleteBtn.png"></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="b-l-n one-td" style="text-align: left; padding-left: 20px">
                                        <div class="order-info">
                                            <div class="Iconimg"><img src="<?php echo IMG?>/common/CIcon.png"></div>
