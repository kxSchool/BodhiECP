...
$result = $db->update(array('order_sn_shop'=>$order_sn_shop),'order_info','order_id = '.$_SESSION["order_info"]['order_id']);
...
$input->SetTotal_fee($_SESSION["order_info"]["Total_fee"]);
$input->SetTime_start(date("YmdHis"));
$input->SetTime_expire(date("YmdHis", time() + 600));
$input->SetGoods_tag("test");
$input->SetNotify_url("http://www.kxschool.com/pay/wxpay/example/notify.php");
$input->SetTrade_type("NATIVE");
$input->SetProduct_id("123456789");
$result = $notify->GetPayUrl($input);
$url2 = $result["code_url"];

echo "https://www.kxschool.com/pay/wxpay/example/qrcode.php?data=".urlencode($url2);exit;
