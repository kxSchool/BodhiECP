...
$res = array(
    ...
    'ad_path' => '/data/BodhiEC/code/admin/uploads/'.$ad_str.'/',//广告存放位置
    'ad_url' => $adminUrl.'/uploads/'.$ad_str.'/',//引用广告链接
    'thumb_path' => '/data/BodhiEC/code/admin/uploads/thumb/',//文章缩略图存放位置
    'thumb_url' => $adminUrl.'/uploads/thumb/',//引用文章缩略图链接
    'logo_path' => '/data/BodhiEC/code/admin/uploads/logo/',//站点logo存放位置
    'logo_url' => $adminUrl.'/uploads/logo/',//引用站点logo链接
    'resource_path' => '/data/BodhiEC/code/admin/uploads/resource/',//站点资源存放位置
    'resource_url' => $adminUrl.'/uploads/resource/',//引用站点资源o链接
    'max_members' => 300000,//每张用户表的最大纪录数
    'admin_avatar_path' => '/data/BodhiEC/code/admin/uploads/adminavatar/',//后台管理员存放头像路径
    'admin_avatar_url' => $adminUrl.'/uploads/adminavatar/',//访问后台管理员存放头像路径
    'staff_avatar_path' => '/data/BodhiEC/code/admin/uploads/staffavatar/',//后台管理员存放头像路径
    'staff_avatar_url' => $adminUrl.'/uploads/staffavatar/',//访问后台管理员存放头像路径
    'members_avatar_path' => '/data/BodhiEC/code/admin/uploads/avatar/',//会员存放头像路径
    'members_avatar_url' => $adminUrl.'/uploads/avatar/',//访问会员存放头像路径
    'seller_video_path' => '/data/BodhiEC/code/admin/uploads/seller_video/',//卖家形象视频路径
    'seller_video_url' => $adminUrl.'/uploads/seller_video/',//访问卖家存放视频路径
    'seller_images_path' => '/data/BodhiEC/code/admin/uploads/seller_images/',//卖家形象视频路径
    'seller_images_url' => $adminUrl.'/uploads/seller_images/',//访问卖家存放视频路径
    'seller_certificate_path' => '/data/BodhiEC/code/admin/uploads/seller_certificate/',//卖家认证照片路径
    'seller_certificate_url' => $adminUrl.'/uploads/seller_certificate/',//访问卖家存放认证照片路径
    'seller_identity_path' => '/data/BodhiEC/code/admin/uploads/seller_identity/',//卖家身份认证照片路径
    ...
    //产品图片路径
    'goods_images_path' => '/data/BodhiEC/code/admin/uploads/goods_images/',//产品图片路径
    'goods_images_url' => $adminUrl.'/uploads/goods_images/',//产品图片路径
    //入驻审核资料路径
    'identity_join_path' => '/data/BodhiEC/code/admin/uploads/identity/',
    'identity_join_url' => $adminUrl.'/uploads/identity/',

    //产品图片路径
    'goods_details_path' => '/data/BodhiEC/code/admin/uploads/goods_details/',//产品图片路径
    'goods_details_url' => $adminUrl.'/uploads/goods_details/',//产品图片路径
    //新闻图片路径
    'news_image_path' => '/data/BodhiEC/code/admin/uploads/news_images/',
    'news_image_url' => $adminUrl.'/uploads/news_images/',
    //新添加
    'brand_path' => '/data/BodhiEC/code/admin/uploads/brand/',//品牌logo存放位置
    'brand_url' => $adminUrl.'/uploads/brand/',
    //新添加
    'show_path' => '/data/BodhiEC/code/admin/uploads/show/',//表演海报存放位置
    'show_url' => $adminUrl.'/uploads/show/',
    //新添加
    'venue_path' => '/data/BodhiEC/code/admin/uploads/venue/',//场馆海报存放位置
    'venue_url' => $adminUrl.'/uploads/venue/',
    //新添加
    'mapBackground_path' => '/data/BodhiEC/code/admin/uploads/map/',//选座图背景存放位置
    'mapBackground_url' => $adminUrl.'/uploads/map/',
    //新添加
    'mapMini_path' => '/data/BodhiEC/code/admin/uploads/map/',//选座缩略图存放位置
    'mapMini_url' => $adminUrl.'/uploads/map/',
    //新添加
    'full_path' => '/data/BodhiEC/code/admin/uploads/360/',//品牌logo存放位置
    ...
    //分类关联品牌的分类路径
    'category_brand_json_path' => '/data/BodhiEC/code/admin/static/json/categorybrandjson/',
    'category_brand_json_url' => $adminUrl.'/static/json/categorybrandjson/',
    //静态分类路径
    'categoryJson_path' => '/data/BodhiEC/code/admin/static/json/categoryJson.js',
    'categoryJson_url' => $adminUrl.'/static/json/categoryJson.js',
    //省市县路径
    'cityJson_path' => '/data/BodhiEC/code/admin/static/json/cityJson.js', //省市县
    'cityJson_url' => $adminUrl.'/static/json/cityJson.js',
    //品牌-厂商-车系路径
    'carJson_path' => '/data/BodhiEC/code/admin/static/json/car/',
    'carJson_url' => $adminUrl.'/static/json/car/',

    //广告缓存路径
    'adJson_path' => '/data/BodhiEC/code/admin/static/json/'.$ad_str.'/',
    'adJson_url' => $adminUrl.'/static/json/'.$ad_str.'/',

    // 商城缓存文件路径
    'Shop_Cache_VIEW_Path' =>'data/BodhiEC/code/admin/cache/shop/',
    ...
    //广告图片路径：商铺的广告图片
    'seller_ads_images_path' => '/data/BodhiEC/code/admin/uploads/seller_'.$ad_str.'_images/',//产品图片路径
    'seller_ads_images_url' => $adminUrl.'/uploads/seller_'.$ad_str.'_images/',//产品图片路径

    //静态二级分类路径
    'categoryJson_two_path' => '/data/BodhiEC/code/admin/static/json/twoCategoryJson.js',
    'categoryJson_two_url' => $adminUrl.'/static/json/twoCategoryJson.js',

    //静态页面
    'web_html'  =>  '/data/BodhiEC/code/www/html/',
    'shop_html'  =>  '/data/BodhiEC/code/www/html/',

    //静态二级分类+广告路径
    'categoryJson_two_ads_path' => '/data/BodhiEC/code/admin/static/json/'.$ad_str.'/twoCategory'.$ad_str.'Json.js',
    'categoryJson_two_ads_url' => $adminUrl.'/static/json/'.$ad_str.'/twoCategory'.$ad_str.'Json.js',

    //json路径
    'json_path' =>'data/BodhiEC/code/admin/static/json/',
    'json_url'=> $adminUrl.'/static/json/',

    // 商品工具文件上传下载目录
    'web_tool_excle_path' =>'/data/BodhiEC/code/admin/uploads/',
    'web_tool_excle_libraries_path' =>'/data/BodhiEC/code/www/application/libraries/Excel/excel.php',
    // 商品默认图片路径
    'goods_default_image_path' => '/data/BodhiEC/code/admin/uploads/default_goods_images/',
