                                ...
                                <?php if(isset($order_progress) && !empty($order_progress)):?>
                                    <?php foreach ($order_progress as $key => $value):?>
                                        <?php if($value['isFinish']==1):?>
                                            <a class="finished" disabled="disabled" data-sort="<?php echo $value['sort'];?>" data-progress="<?php echo $value['progress_id'];?>"  data-toggle="tooltip" data-placement="top" data-original-title="<?php echo $value['goods_name'];?>:<?php echo $value['progress'];?>" ><?php echo date('Y-m-d H:i:s',$value['updatetime']);?><br /> <?php echo $value['goods_name'];?>:<?php echo $value['progress'];?></a>
                                        <?php else:?>

                                            <a disabled="disabled" class="unfinished"  data-sort="<?php echo $value['sort'];?>" data-progress="<?php echo $value['progress_id'];?>" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo $value['goods_name'];?>:<?php echo $value['progress'];?>">待完成<br /> <?php echo $value['goods_name'];?>:<?php echo $value['progress'];?></a>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <?php if(isset($order_record) && !empty($order_record)):?>
                                            <?php foreach($order_record as $record):?>
                                                <tr>
                                                    ...
                                                    <td><?php echo date('Y-m-d H:i:s',$record['updatetime']);?></td>
                                                </tr>
                                            <?php endforeach;?>
                                        <?php endif;?>
                                        </tbody>
