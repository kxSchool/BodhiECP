                            ...
                            <div class="box-body no-padding">
                                <div class="mailbox-controls">
                                            ...
                                            <select name="catid" id="catid" class="form-control">
                                                <?php if(isset($list) && !empty($list)):?>
                                                    <?php foreach ($list as $key => $value):?>
                                                        ...
                                                        <option value="<?php echo $value['catid'];?>" <?php if($value['type'] == 1){echo 'disabled=""';}?> <?php if($value['catid'] == $catid){echo 'selected';}?>> <?php echo $nbsp.$value['spacer'].$value['catname'];?></option>
                                                    <?php endforeach;?>
                                                <?php endif;?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="title" class="form-control" name="title" type="text" value="<?php echo $title;?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                            <div class="input-group">
                                                <input id="thumb_name" class="form-control" size="50" type="text"  value="<?php echo $thumb;?>">
                                                <input id="thumb_path" class="form-control" size="50" name="thumb" type="hidden" value="<?php echo $thumb;?>">
...
<!--                                                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false">/cms/article</button>-->
<!--                                                </div>-->
<!--                                                <input type="text" name="url" class="form-control" placeholder="请输入自定义的名称,为空将使用主键ID"  value="--><?php //echo $url;?><!--">-->
<!--                                            </div>-->
<!--                                        </div>-->
<!--                                    </div>-->
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                            <input id="keywords" data-rule="" class="form-control" name="keywords" type="text" value="<?php echo $keywords;?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="description" class="col-sm-2 control-label">描述</label>
                                        <div class="col-xs-12 col-sm-8">
                                            <textarea id="description" cols="60" rows="5" data-rule="" class="form-control" name="description" ><?php echo $description;?></textarea>
                                        </div>
                                    </div>
                                ...
                                <div id="myTabContent" class="tab-content" style="margin-top: 20px">
                                    <div class="tab-pane fade active in" id="one">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-8">
                                                <div class="input-group margin-bottom-sm">
                                                    ...
                                                    <input id="views" class="form-control" name="views" placeholder="浏览" type="number" value="<?php echo $views;?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-8">
                                                <div class="input-group margin-bottom-sm">
                                                    <input id="listorder" class="form-control" name="listorder" placeholder="排序" type="number" value="<?php echo $listorder;?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="myTabContent" class="tab-content" style="margin-top: 20px">
                                    <div class="tab-pane fade active in" id="one">
                                            ...
                                            <div class="col-xs-12 col-sm-8">
                                                ...
                                                <div class="btn-group bootstrap-select show-tick form-control">
                                                    ...
                                                    <select id="flag" class="form-control selectpicker" multiple="" name="flag[]" tabindex="-98">
                                                        <option value="top" <?php if($top==1){echo 'selected';}?>>置顶</option>
                                                        <option value="recommend" <?php if($recommend==1){echo 'selected';}?>>推荐</option>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-8">
                                                <div class="radio">
                                                    <label for="isshow-1"><input id="isshow-1" name="isshow" type="radio" value="1" <?php if($isshow == 1){echo 'checked';}?>> 显示</label>
                                                    <label for="isshow-0"><input id="isshow-0" name="isshow" type="radio" value="0" <?php if($isshow == 0){echo 'checked';}?>> 隐藏</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-8">
                                                <div class="radio">
                                                    <label for="publishtime-1"><input id="publishtime-1" name="publishtime" type="radio" value="1"  <?php if($status == 1){echo 'checked';}?>> 发布</label>
                                                    <label for="publishtime-0"><input id="publishtime-0" name="publishtime" type="radio" value="0" <?php if($status != 1){echo 'checked';}?>> 保存</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
