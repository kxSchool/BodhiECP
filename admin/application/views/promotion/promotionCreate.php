					...
					<div class="box-body">
						<form id="promotionForm" class="form-horizontal" method="post" action="<?php echo site_url('promotion/savePromotion');?>">
                            <div class="form-group">
                                <label for="send_type" class="col-sm-2 control-label">促销生成类型：</label>
								<div class="col-sm-6">
									<input type="radio" name="send_type" value="0" checked="checked" /> 卡券
								</div>
                            </div>
                            <div class="form-group">
								<label for="type_name" class="col-sm-2 control-label">卡券标题：</label>
								<div class="col-sm-6">
									<input type="text" class="form-control" name="type_name" id="type_name" placeholder="输入卡券标题" value=""/>
								</div>
							</div>
                            <div class="form-group">
								<label for="type_money" class="col-sm-2 control-label">卡券金额：</label>
								<div class="col-sm-6">
									<input type="text" class="form-control" name="type_money" id="type_money" placeholder="输入卡券金额" value="" />
                                </div>
							</div>
                            <div class="form-group">
								<label for="use_start_date" class="col-sm-2 control-label">使用有效期：</label>
								<div class="col-sm-2">
									<input type="text" class="form-control" name="use_start_date" id="use_start_date" placeholder="开始时间" value="" />
								</div>
								<div class="col-sm-2 text-center">
									<span class="text-center">至</span>
								</div>
								<div class="col-sm-2">
									<input type="text" class="form-control" name="use_end_date" id="use_end_date" placeholder="结束时间" value="" />
								</div>
							</div>
                            <div class="form-group">
								...
								<div class="col-sm-6">
									<select class="form-control" name="use_type" id="use_type">
										<option value="0">不支持并用</option>
										<option value="1">支持并用</option>	
									</select>
                                </div>
							</div>
                            <div class="form-group">
								...
								<div class="col-sm-6">
								   <input type="radio" name="build_action" value="0" checked="checked"/> 凭同一暗号
                                   <input type="radio" name="build_action" value="1" /> 凭不同的促销码
                                </div>
							</div>
							<div class="form-group" id="anHao" style="display:block;">
								<label for="anhao" class="col-sm-2 control-label">暗号：</label>
								<div class="col-sm-6">
									<input type="text" class="form-control" name="anhao" id="anhao" placeholder="输入暗号" value="" />
								</div>
							</div>
							<div class="form-group" id="cuXiaoMa" style="display:none;">
								<label for="num" class="col-sm-2 control-label">促销码位数：</label>
								<div class="col-sm-2">
									<input type="text" class="form-control" name="num" id="num" placeholder="输入促销码位数" value="" />
								</div>
								<div class="col-sm-1 text-center">
									<span class="text-center">以</span>
								</div>
								<div class="col-sm-2">
									<input type="text" class="form-control" name="cuxiaomastart" id="cuxiaomastart" placeholder="输入开头" value="" />
								</div>
								<div class="col-sm-1 text-center">
