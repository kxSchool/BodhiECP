						...
						<form id="spaceForm" class="form-horizontal" method="post" action="<?php echo site_url('ad/saveSpace');?>">
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<input type="text" class="form-control" name="name" id="name" placeholder="广告位名" value="<?php echo $name;?>" />
								</div>
							</div>
							<div class="form-group">
								<label for="width" class="col-sm-2 control-label">宽度：</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="width" id="width" placeholder="输入宽度,最多保留小数点后一位小数" value="<?php echo $width;?>" />
								</div>
							</div>
							<div class="form-group">
								<label for="height" class="col-sm-2 control-label">高度：</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="height" id="height" placeholder="输入高度，最多保留小数点后一位小数" value="<?php echo $height;?>" />
								</div>
							</div>
							<div class="form-group">
								<label for="description" class="col-sm-2 control-label">描述：</label>
								<div class="col-sm-10">
									<textarea class="form-control" name="description" id="description" placeholder="输入广告位描述"><?php echo $description;?></textarea>
								</div>
							</div>
